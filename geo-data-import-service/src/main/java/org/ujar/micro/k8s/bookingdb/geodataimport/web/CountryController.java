package org.ujar.micro.k8s.bookingdb.geodataimport.web;
...
public class CountryController {
  ...
  private final CountryRepository profileRepository;
  ...
  public ResponseEntity<CountryEntity> findById(@PathVariable final Long id) {
  ...
  public ResponseEntity<Page<CountryEntity>> findAll(@ParameterObject @Valid PageRequestDto request) {
